---
title: "Supplemental material for “The network structure of general practice in Australia: analysis of national claims data”"
output:
...
1. [About Blockmodelling]
2. [Extracting hierarchical blockmodels]
...
* The Jupyter Notebook [`supplemental.ipynb`](/py/supplemental.ipynb) shows a
  minimal example.
* The folder [`pbs`](/pbs) contains Unix scripts which were run on the high-performance
